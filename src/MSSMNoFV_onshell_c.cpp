...
MSSMNoFV_onshell* c_mssm_onshell_new()
{
   return reinterpret_cast<MSSMNoFV_onshell*>(new gm2calc::MSSMNoFV_onshell());
}

void c_mssm_onshell_free(MSSMNoFV_onshell* model)
{
   delete reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model);
}

void c_mssm_onshell_set_TB(MSSMNoFV_onshell* model, double tan_beta)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_TB(tan_beta);
}

void c_mssm_onshell_set_Ae(MSSMNoFV_onshell* model, unsigned i, unsigned k, double a)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_Ae(i,k,a);
}

void c_mssm_onshell_set_Au(MSSMNoFV_onshell* model, unsigned i, unsigned k, double a)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_Au(i,k,a);
}

void c_mssm_onshell_set_Ad(MSSMNoFV_onshell* model, unsigned i, unsigned k, double a)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_Ad(i,k,a);
}

void c_mssm_onshell_set_Mu(MSSMNoFV_onshell* model, double mu)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_Mu(mu);
}

void c_mssm_onshell_set_MassB(MSSMNoFV_onshell* model, double mass_b)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_MassB(mass_b);
}

void c_mssm_onshell_set_MassWB(MSSMNoFV_onshell* model, double mass_wb)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_MassWB(mass_wb);
}

void c_mssm_onshell_set_MassG(MSSMNoFV_onshell* model, double mass_g)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_MassG(mass_g);
}

void c_mssm_onshell_set_MA0(MSSMNoFV_onshell* model, double MA0)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_MA0(MA0);
}

void c_mssm_onshell_set_mq2(MSSMNoFV_onshell* model, unsigned i, unsigned k, double mq2)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_mq2(i,k,mq2);
}

void c_mssm_onshell_set_mu2(MSSMNoFV_onshell* model, unsigned i, unsigned k, double mu2)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_mu2(i,k,mu2);
}

void c_mssm_onshell_set_md2(MSSMNoFV_onshell* model, unsigned i, unsigned k, double md2)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_md2(i,k,md2);
}

void c_mssm_onshell_set_ml2(MSSMNoFV_onshell* model, unsigned i, unsigned k, double ml2)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_ml2(i,k,ml2);
}

void c_mssm_onshell_set_me2(MSSMNoFV_onshell* model, unsigned i, unsigned k, double me2)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_me2(i,k,me2);
}

void c_mssm_onshell_set_scale(MSSMNoFV_onshell* model, double scale)
{
   return reinterpret_cast<gm2calc::MSSMNoFV_onshell*>(model)->set_scale(scale);
}

void c_mssm_onshell_calculate_masses(MSSMNoFV_onshell* model)
{
