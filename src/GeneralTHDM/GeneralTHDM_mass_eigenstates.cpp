...
Eigen::Matrix<double,3,3> CLASSNAME::get_mass_matrix_Fu() const
{
   ...
   mass_matrix_Fu(0,0) = 0.7071067811865475*v1*Xu(0,0) + 0.7071067811865475*v2*
      Yu(0,0);
   mass_matrix_Fu(0,1) = 0.7071067811865475*v1*Xu(1,0) + 0.7071067811865475*v2*
      Yu(1,0);
   mass_matrix_Fu(0,2) = 0.7071067811865475*v1*Xu(2,0) + 0.7071067811865475*v2*
      Yu(2,0);
   mass_matrix_Fu(1,0) = 0.7071067811865475*v1*Xu(0,1) + 0.7071067811865475*v2*
      Yu(0,1);
   mass_matrix_Fu(1,1) = 0.7071067811865475*v1*Xu(1,1) + 0.7071067811865475*v2*
      Yu(1,1);
   mass_matrix_Fu(1,2) = 0.7071067811865475*v1*Xu(2,1) + 0.7071067811865475*v2*
      Yu(2,1);
   mass_matrix_Fu(2,0) = 0.7071067811865475*v1*Xu(0,2) + 0.7071067811865475*v2*
      Yu(0,2);
   mass_matrix_Fu(2,1) = 0.7071067811865475*v1*Xu(1,2) + 0.7071067811865475*v2*
      Yu(1,2);
