...
double amu2L_B_EWadd(const THDM_B_parameters& thdm) noexcept
{
   ...
   const double xm1 = 32*(-240*cw4*lh + 1536*cw6*lh - 177*cw4*lh2 + 240*cw6*lh2 + 6*(40*cw4 - 256*cw6 + 752*cw8) - 10*cw2*phi6 + 59*cw4*phi4 - 80*cw6*phi4 + 
       64*cw12*(6*(18 + 9*lc - 9*lh + li3) - pi2) - 177*cw4*pi2 + 240*cw6*pi2 - 20*cw4*phi1 + 128*cw6*phi1 - 
