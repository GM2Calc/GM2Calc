...
double amu2L_B_EWadd(const THDM_B_parameters& thdm) noexcept
{
   ...
   const auto phi7 = (6.*(l4*l5 - li6 - li7) + pi2)*s2;

   const auto xm2 = 128.*(5*cw4*(-3*lh2 + phi4 - 3*pi2) + 16*cw12*(-6*li3 + pi2) + 8*(4*cw6 - 7*cw8)*(3*lh2 - phi4 + 3*pi2) + 4*cw10*(24*lh2 + 6*li3 - 8.*phi4 + 23*pi2) - 90*cw10*phi7 + 
      18*(4*cw12 + cw8)*phi7);
